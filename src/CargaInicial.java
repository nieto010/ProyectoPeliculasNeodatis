...
public class CargaInicial {
    ...
    public static void main(String[] args) {
        ...
        Pelicula p1 = new Pelicula("El Padrino", 4.7, "Francis Ford Coppola", "El padrino es una pelicula estadounidense de 1972 dirigida por Francis Ford Coppola. La pelicula fue producida por Albert S. Ruddy, de la compania Paramount Pictures", 177, "20/10/1972", true, new ArrayList<Genero>(List.of(drama)));
        ...
        Pelicula p12 = new Pelicula("King Kong", 3.7, "Peter Jackson", "La ambicion de Carl hara que decida secuestrar al simio para trasladarlo a Nueva York y exponerlo como si fuera una obra de arte para ganar dinero.", 180, "16/12/2005", false, new ArrayList<Genero>(List.of(drama,accion,aventuras)));
        ...
        Pelicula p15 = new Pelicula("Solo en casa", 4.3, "Chris Columbus", "Sin embargo esta nueva libertad tiene un precio, pues rapidamente ha de aprender algunas lecciones basicas sobre responsabilidad, madurez e independencia.", 103, "21/12/1990", false, new ArrayList<Genero>(List.of(comedia)));
        Pelicula p16 = new Pelicula("Mad Max: Furia en la carretera", 4.1, "George Miller", "Dos rebeldes que son capaces de restaurar el orden perdido, por un lado esta Max, que sigue buscando su propia paz tras la muerte de su mujer y su hijo; y por otro lado está Imperator Furiosa, una misteriosa mujer que trata de sobrevivir en este peligroso viaje hacia su hogar.", 120, "15/05/2015", true, new ArrayList<Genero>(List.of(accion,aventuras,cienciaFiccion)));
        Pelicula p17 = new Pelicula("The Matrix", 4.3, "Lana Wachowski", "Su vida cambiara cuando una noche conozca a Trinity , una misteriosa joven que parece ser una leyenda en el mundo de los 'hackers' informaticos. Sera ella quien lleve a Neo ante su lider: Morfeo.", 135, "25/06/1999", true, new ArrayList<Genero>(List.of(accion,cienciaFiccion)));
        ...
        Pelicula p21 = new Pelicula("REC", 3.8, "Paco Plaza", "Hasta la llamada telefonica de una anciana que pide ayuda. Al llegar, los bomberos observan que los vecinos estan muy impacientes. Se oyen horribles gritos en el apartamento de la vieja mujer", 80, "23/11/2007", true, new ArrayList<Genero>(List.of(terror,misterio,suspense)));
        Pelicula p22 = new Pelicula("El exorcista", 4.4, "William Friedkin", "En Iraq, el Padre Merrin queda profundamente turbado por el descubrimiento de una figurilla del demonio Pazuzu y las macabras visiones que esta provoca. Mientras tanto, en Washington, en la casa de la actriz Chris MacNeil se estan produciendo extranos fenomenos: la despiertan extranos sonidos que vienen del granero", 121, "01/09/1975", false, new ArrayList<Genero>(List.of(terror)));
