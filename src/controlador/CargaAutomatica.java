...
public class CargaAutomatica {
	...
	public static void cargaInicial() {
		...
		NeodatisHelper neodatisHelper = new NeodatisHelper();
        ...
        Pelicula p1 = new Pelicula("El Padrino", 4.7, "Francis Ford Coppola", "El padrino es una pelicula estadounidense de 1972 dirigida por Francis Ford Coppola. La pelicula fue producida por Albert S. Ruddy, de la compania Paramount Pictures", 177, "20/10/1972", true, new ArrayList<>(Collections.singletonList(drama)));
        ...
        Pelicula p14 = new Pelicula("Scary Movie", 3.6, "Keenen Ivory Wayans", "Una noche, Drew Becker recibe una llamada anonima de un maniaco. Su muerte sume a sus compañeros de instituto en una pesadilla, especialmente porque ahora tendran que enfrentarse a un asesino en serie que se oculta entre ellos.", 84, "31/10/2000", true, new ArrayList<>(Collections.singletonList(comedia)));
        Pelicula p15 = new Pelicula("Solo en casa", 4.3, "Chris Columbus", "Sin embargo esta nueva libertad tiene un precio, pues rapidamente ha de aprender algunas lecciones basicas sobre responsabilidad, madurez e independencia.", 103, "21/12/1990", false, new ArrayList<>(Collections.singletonList(comedia)));
        ...
        Pelicula p22 = new Pelicula("El exorcista", 4.4, "William Friedkin", "En Iraq, el Padre Merrin queda profundamente turbado por el descubrimiento de una figurilla del demonio Pazuzu y las macabras visiones que esta provoca. Mientras tanto, en Washington, en la casa de la actriz Chris MacNeil se estan produciendo extranos fenomenos: la despiertan extranos sonidos que vienen del granero", 121, "01/09/1975", false, new ArrayList<>(Collections.singletonList(terror)));
        ...
        System.out.println("Carga automatica efectuada correctamente");
